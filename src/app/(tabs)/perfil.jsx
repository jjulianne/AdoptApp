...
console.log("user en el perfil ")
  ...
  <View style={[styles.profileImage, { backgroundColor: '#ccc', justifyContent: 'center', alignItems: 'center' }]}>
    <Text style={{ color: '#fff' }}>Sin foto</Text>
          ...
          <Text style={styles.profileLocation}>{user?.location || 'Ubicación no especificada'}</Text>
         {/* <Text style={styles.profileDescription}>
            {user?.description || 'Sin descripción aún.'}
          </Text>*/}

          {/* Botón para editar perfil */}
          <TouchableOpacity style={styles.editButton} onPress={() => router.push('/editar-perfil')}>
...
const styles = StyleSheet.create({
  ...
  container: {marginTop:50, flex: 1, backgroundColor: '#F2F2F7', paddingTop: 15 },
  header: {
    alignItems: 'center',
    paddingVertical: 10,
    backgroundColor: '#fff',
